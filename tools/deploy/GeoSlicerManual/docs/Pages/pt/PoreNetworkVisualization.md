...
Esse módulo serve para controlar e visualizar as simulações de permeabilidade relativa criadas no módulo [Pore Network Simulation](/Volumes/PNM/PNM.md#two-phase) com a opção "Create animation node" ativada.
