...
| Figura 4: Watershed no módulo Segment Inspector. |
 ...
 - _Calculate Coordination Number_: Calcula o número de regiões vizinhas (que dividem fronteira) com cada um dos rótulos (_labels_) do watershed. Consideramos como um "vizinho" todo rótulo que compartilhe uma face, aresta ou vértice de outro próximo.
