...
Este módulo remove as bordas de uma segmentação em uma imagem grande (formato NetCDF). Para mais informações sobre a versão interativa desta ferramenta, veja o efeito [Remoção de Borda](/Volumes/Segmentation/Segmentation.md#boundary-removal) no Segment Editor.
