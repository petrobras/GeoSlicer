## <a id="pore-stats">Pore Stats: estatísticas e propriedades de poros e partículas em seção delgada</a>
...
Uma vez que uma imagem é carregada, sua região porosa é segmentada através dos **[modelos pré-treinados](/ThinSection/Segmentation/Segmentation.md#automatic-thin-section-segmentation)**
...
Uma vez que a região porosa esteja devidamente segmentada e "limpa", o recurso de **[Particionamento](/ThinSection/Segmentation/Segmentation.md#segment-inspector)**
