...
1.  Defina a imagem de entrada e segmentação de saída conforme o [tutorial de uso do *Segment Editor*](/ThinSection/Segmentation/Segmentation.md/#manual-segmentation). Criar segmentação/segmentos não é necessário caso prefira editar segmentos já existentes.
...
8.  Caso utilize a **versão pública do GeoSlicer**, um campo *Annotations* deve estar visível, e os passos a seguir deverão ser executados. Caso contrário, pule este passo.
    ...
    *   Selecione um dos novos segmentos criados. Utilize efeitos de marcação como [Desenho (*Draw*)](/ThinSection/Segmentation/Segmentation.md#draw), [Pintura (*Paint*)](/ThinSection/Segmentation/Segmentation.md#paint) ou [Tesoura (*Scissors*)](/ThinSection/Segmentation/Segmentation.md#scissors) para demarcar pequenas amostras da textura da rocha.
