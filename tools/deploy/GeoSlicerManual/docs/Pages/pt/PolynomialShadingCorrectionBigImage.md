...
Para uma descrição detalhada do algoritmo base de correção de sombreamento, consulte o manual do filtro [Polynomial Shading Correction](/Volumes/Filter/Filter.md#polynomial-shading-correction).
