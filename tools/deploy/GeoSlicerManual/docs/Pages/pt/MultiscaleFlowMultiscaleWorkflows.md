...
#### **Dados de Image Log:**
1. Import: Image Log Import ou *[Geolog Integration](/Multiscale/GeologIntegration/GeologEnv.md)*
2. Inpaint: *[Preenchimento de Image Log](/Multiscale/ImageLogPreProcessing/ImageLogPreProcessing.md#image-log-inpaint)*
3. Spiral Filter
4. Crop: *[Recorte de Image Log](/Multiscale/ImageLogPreProcessing/ImageLogPreProcessing.md#image-log-crop)*
5. Segmentation
6. Image log export
...
### Simulando com *[Multiscale](/Multiscale/MultiscaleImageGeneration/Multiscale.md)*
...
5. Exportar dado após simulação: Volumes export (TIF, RAW e outros dados). É possível exportar resultados da simulação como TIF diretamente do módulo [Multiscale Image Generation](/Multiscale/MultiscaleImageGeneration/Multiscale.md)
