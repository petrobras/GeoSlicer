...
-   É possível importar um arquivo NetCDF usando o [**Carregador de Micro CT**](/Volumes/MicroCTImport/Import.md).
-   Para arquivos NetCDF que contêm imagens muito grandes para caber na memória, você pode usar o módulo [**Big Image**](/Volumes/BigImage/BigImage.md) para visualizá-los e processá-los de forma eficiente.
