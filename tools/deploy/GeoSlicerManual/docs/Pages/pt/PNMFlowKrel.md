...
4.  Utilize a aba **[Extraction](/Volumes/PNM/PNM.md#extractor)** para obter a rede de poros e ligações a partir do volume LabelMap gerado;
5.  Na aba **[Simulation](/Volumes/PNM/PNM.md#two-phase)**;
6.  Marque a opção **"Create animation node"** na caixa **["Simulation options"](/Volumes/PNM/PNM.md#simulation-options)** e clique no botão **"Apply"**;
