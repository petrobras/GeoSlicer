...
class PoreFlowSubprocess(TwoPhaseSubprocess):
    ...
    def caller(cwd, params_in, statoil_data, snapshot_file=None, write_debug_files=False):
        ...
        py_pore_flow_parameters = {
            ...
            "initial_ca_gamma": params["init_contact_angle_eta"],
            "initial_ca_delta": params["init_contact_angle_del"],
            "initial_ca_sigma": params["init_contact_angle_sig"],
            ...
            "equilibrium_ca_delta": params["equil_contact_angle_del"],
            "equilibrium_ca_sigma": params["equil_contact_angle_sig"],
