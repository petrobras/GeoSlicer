...
class WorkflowWidget(qt.QDialog):
    ...
    def menuBarInterface(self):
        ...
        loadWorkflowAction = qt.QAction(qt.QIcon(getResourcePath("Icons") / "png" / "Load.png"), "&Load...", fileMenu)
        saveWorkflowAction = qt.QAction(qt.QIcon(getResourcePath("Icons") / "png" / "Save.png"), "&Save", fileMenu)
    ...
    def toolBarInterface(self):
        ...
        runWorkflowAction = qt.QAction(qt.QIcon(getResourcePath("Icons") / "png" / "Run.png"), "Run workflow", toolBar)
        toolBar.addAction(runWorkflowAction)
        stopWorkflowAction = qt.QAction(
            qt.QIcon(getResourcePath("Icons") / "png" / "Stop.png"), "Stop workflow", toolBar
        )
    ...
    def workflowPanel(self):
        ...
        addWorkstepButton.setIcon(qt.QIcon(getResourcePath("Icons") / "png" / "Add.png"))
        addCloneDeleteWorkstepsButtonsLayout.addWidget(addWorkstepButton)
        self.deleteWorkstepButton = qt.QPushButton("Delete workstep")
        self.deleteWorkstepButton.setIcon(qt.QIcon(getResourcePath("Icons") / "png" / "Delete.png"))
    ...
    def workstepPanel(self):
        ...
        resetWorkstepButton.setIcon(qt.QIcon(getResourcePath("Icons") / "png" / "Reset.png"))
