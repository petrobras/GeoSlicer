...
class RawLoaderWidget(qt.QFrame):
    ...
    def setup(self):
        ...
        self.imageSkipSpinBox.valueChanged.connect(self.onImageSizeChanged)
        self.imageSizeXSliderWidget.valueChanged.connect(self.onImageSizeChanged)
        self.imageSizeYSliderWidget.valueChanged.connect(self.onImageSizeChanged)
        self.imageSizeZSliderWidget.valueChanged.connect(self.onImageSizeChanged)
        self.imageSpacingXSliderWidget.valueChanged.connect(self.onImageSizeChanged)
        self.imageSpacingYSliderWidget.valueChanged.connect(self.onImageSizeChanged)
        self.imageSpacingZSliderWidget.valueChanged.connect(self.onImageSizeChanged)
